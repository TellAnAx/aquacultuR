...
|Absolute growth rate                             |AGR      |           |$\text{AGR}$               |$g\,d^{-1}$
...
|Feeding rate                                     |FR       |           |$\text{FR}$                |$g\,d^{-1}$
|Geometric body weight                            |GBW      |           |$\text{GBW}$               |$g$
|Instantaneous Growth                             |IGR      |           |$\text{IGR}$               |$\text{--}$
|Metabolic body weight                            |MBW      |           |$\text{MBW}$               |$g^{0.8}$
|Nutrient Efficiency Ratio                        |NER      |           |$\text{NER}$               |$\text{--}$
|Relative growth                                  |RG       |           |$\Delta m_{rel}$           |$\%$
|Relative growth rate                             |RGR      |           |$\text{RGR}$               |$\%\;d^{-1}$
|Relative growth rate - Arithmetic                |RGR-Ari  |           |$\text{RGR}$               |$\%\;d^{-1}$
|Relative growth rate - Geometric                 |RGR-GBW  |           |$\text{RGR}$               |$\%\;d^{-1}$
|Specific growth rate                             |SGR      |           |$\text{SGR}$               |$\%\;d^{-1}$
|Thermal growth coefficient                       |TGC      |           |$\text{TGC}$               |$g^{1/3}\,^{\circ}C^{-1}\,d^{-1}$
