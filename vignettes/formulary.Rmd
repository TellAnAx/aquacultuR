...
$$
\text{ADC}_{\text{DM}} = 
  100 - 100 \cdot (\frac{\gamma_{feed}}{\gamma_{feces}})
$$
...
$$
\text{ADC}_{\text{DM}} = 
  100 - 100 \cdot (\frac{\gamma(standard)_{feed}} {\gamma(standard)_{feces}} \cdot \frac{\gamma(nutrient)_{feces}}{\gamma(nutrient)_{feed}})
$$
...
$$
\text{ADC}_{ingr} = ADC_{test} + (ADC_{test} - ADC_{ref}) \cdot (\frac{f_{ref} \cdot \gamma(nutrient)_{ref}}{f_{ingredient} \cdot \gamma(nutrient)_{ingredient}})
$$
